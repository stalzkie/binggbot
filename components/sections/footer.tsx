              ...
              >
                ...
                >
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground/80">
                    Automate customer support, boost engagement, and scale your operations effortlessly with our cutting-edge conversational AI solutions.
                  </p>
                  
                  <div className="flex flex-wrap justify-center gap-4 mt-6">
                    {['24/7 Support', 'Multi-Language', 'Easy Integration', 'Analytics'].map((feature, index) => (
                      <motion.span
                        key={feature}
                ...
                >
                  <p className="text-sm text-muted-foreground/60 mb-6 font-medium">Connect with us</p>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm text-muted-foreground">
              <button 
                onClick={() => document.querySelector('#privacy')?.scrollIntoView({ behavior: 'smooth' })}
              ...
              <button 
                onClick={() => document.querySelector('#cookies')?.scrollIntoView({ behavior: 'smooth' })}
                className="hover:text-primary transition-colors"
              >
                Cookie Policy
              </button>
